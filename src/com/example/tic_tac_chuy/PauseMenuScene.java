...
public class PauseMenuScene extends MenuScene{
	...
	public PauseMenuScene(Camera camera)
	{
		...
		this.mMenuTexture = new BitmapTextureAtlas((TextureManager) Global.getResource(Global.TEXTURE_MANAGER), 200, 200, TextureOptions.BILINEAR);
		this.mMenuResetTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mMenuTexture, (Context)Global.getResource(Global.MAIN_ACTIVITY), "menu_reset.png", 0, 0);
		...
		final SpriteMenuItem resetMenuItem = new SpriteMenuItem(MENU_RESET, this.mMenuResetTextureRegion, (VertexBufferObjectManager)Global.getResource(Global.VERTEX_BUFFERED_OBJECT_MANAGER) );
